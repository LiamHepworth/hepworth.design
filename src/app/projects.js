...
export const projectList = [
    ...
    new Project(
        'HOLO-DISK READER',
        '3D Model / Animation',
        ['assets/project-images/1-HoloDisk-Reader/image-01.png', 'assets/project-images/1-HoloDisk-Reader/image-02.png'],
        ['assets/project-images/1-HoloDisk-Reader/vid-02.mp4', 'assets/project-images/1-HoloDisk-Reader/vid-01.mp4'],
        null,
        ...
        'assets/project-images/1-HoloDisk-Reader/image-01.png',
    ),
    ...
    new Project(
        ...
        null,
        ['assets/project-images/5-Looping-Geometry/vid-01.mp4', 'assets/project-images/5-Looping-Geometry/vid-02.mp4', 'assets/project-images/5-Looping-Geometry/vid-03.mp4'],
        null,
        ...
        'assets/project-images/5-Looping-Geometry/image-03.png',
    ),
    ...
    new Project(
        ...
        'Mixed Media / Animation',
        null,
        ['assets/project-images/4-Animation-Sketches/vid-03.mp4', 'assets/project-images/4-Animation-Sketches/vid-02.mp4', 'assets/project-images/4-Animation-Sketches/vid-01.mp4'],
        null,
        ...
        'assets/project-images/4-Animation-Sketches/image-01.png',
    ),

    new Project(
        'NUCLEUS',
        '3D Model / Animation',
        ['assets/project-images/2-Nucleus/image-02.png', 'assets/project-images/2-Nucleus/image-01.png'],
        ['assets/project-images/2-Nucleus/vid-01.mp4'],
        null,
        ...
        'assets/project-images/2-Nucleus/image-02.png',
    ),
]; 